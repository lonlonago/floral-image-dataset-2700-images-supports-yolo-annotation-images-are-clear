# Floral Image Dataset 2700 Images Supports Yolo Annotation Images are Clear

# Body

Floral Image Recognition Dataset, 2700 images, support Yolo annotation, clear images, complete annotations, ready to use

This is a suitable flower target detection and recognition model training, worry-free, automatically shipped after purchase， bought and sent immediately.

Annotations
Common Lanthanum → Five-colored Plum
Hibiscus → Pomegranate Flower
Jatropha → Orchid Tree
Marigold → Golden Sunflower
Rose → Rose
Champaka → Yellow Orchid
Chitrak → White Flower Dandelion
Honeysuckle → Gold and Silver Honeysuckle
Indian Mallow → Golden Morningflower
Malabar Melastome → Wild Peony
Shankupushpam → Blue Butterfly Flower
